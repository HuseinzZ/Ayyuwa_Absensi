<div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control" id="employee_id" name="employee_id" required>
                            <option value="all" <?= ($selected_employee_id == 'all') ? 'selected' : ''; ?>>All Employees</option>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control" id="start_date" name="start_date" value="<?= $start_date ?: set_value('start_date'); ?>" required>
                        <?= form_error('start_date', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="end_date">End Date</label>
                        <input type="date" class="form-control" id="end_date" name="end_date" value="<?= $end_date ?: set_value('end_date'); ?>" required>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        <h6 class="m-0 font-weight-bold text-primary">
                            Summary Data (<?= date('d M Y', strtotime($start_date)); ?> to <?= date('d M Y', strtotime($end_date)); ?>)
                        </h6>
                        <a href="<?= base_url('report/print_report?start_date=' . $start_date . '&end_date=' . $end_date . '&employee_id=' . $selected_employee_id); ?>" target="_blank" class="btn btn-success btn-sm">
    ...
    <?php elseif ($start_date && $end_date): ?>
        <div class="alert alert-info mt-4">No attendance data found for the selected filter.</div>
    <?php endif; ?>
