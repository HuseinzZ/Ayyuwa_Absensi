        ...
        <div class="card-body p-4">
            ...
            <?php if (!$attendance || ($attendance && !$attendance['check_out'])): ?>
                <div class="card bg-light mb-4">
                    <div class="card-body text-center">
                        ...
                        <a href="#" id="view-on-map-link" class="btn btn-sm btn-outline-primary d-none" target="_blank">
            ...
            <?php elseif ($attendance && !$attendance['check_out']): ?>
                <div class="alert alert-info d-flex justify-content-between align-items-center" role="alert">
                    <div>
                        <i class="fas fa-clock me-2"></i> Check-in Time: <strong><?= $attendance['check_in']; ?></strong>
                    </div>
                    <span class="badge bg-primary"><?= $attendance['status_in']; ?></span>
                </div>
                <div class="text-center">
                    <form method="post" action="<?= base_url('attendance/do_attendance'); ?>">
                        <input type="hidden" name="latitude" id="latitude">
            ...
            <?php else: ?>
                <div class="alert alert-success d-flex flex-column align-items-center py-4" role="alert">
                    ...
                    <p class="mb-1">Check-in Time: <strong><?= $attendance['check_in']; ?></strong> (<?= $attendance['status_in']; ?>)</p>
                    <p class="mb-0">Check-out Time: <strong><?= $attendance['check_out']; ?></strong> (<?= $attendance['status_out']; ?>)</p>
                </div>
                <div class="text-center mt-3">
                    <a href="<?= base_url('history/index'); ?>" class="btn btn-outline-primary btn-sm">
