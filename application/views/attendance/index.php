<div class="container mt-2">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            ...
            <!-- Location Info (Only if check-in or not checked out) -->
            ...
            <?php elseif ($attendance && !$attendance['check_out']) : ?>
                ...
                <div class="alert alert-info d-flex justify-content-between align-items-center" role="alert">
                    <div>
                        ...
                        Check-in Time: <strong><?= $attendance['check_in']; ?></strong>
                    </div>
            ...
            <?php else : ?>
                ...
                <div class="alert alert-success d-flex flex-column align-items-center py-4" role="alert">
                    ...
                    <p class="mb-1">
                        Check-in Time: <strong><?= $attendance['check_in']; ?></strong> (<?= $attendance['status_in']; ?>)
                    </p>
                    <p class="mb-0">
                        Check-out Time: <strong><?= $attendance['check_out']; ?></strong> (<?= $attendance['status_out']; ?>)
                    </p>
                </div>
