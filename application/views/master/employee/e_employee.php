            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="emp_id" name="emp_id" value="<?= $employee['id']; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="emp_name">Name</label>
                        <input type="text" class="form-control" id="emp_name" name="emp_name" value="<?= $employee['name']; ?>">
                        <?= form_error('emp_name', '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="emp_email">Email</label>
                        <input type="email" class="form-control" id="emp_email" name="emp_email" value="<?= $employee['email']; ?>">
                        <?= form_error('emp_email', '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="emp_gender">Gender</label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="emp_gender" id="genderMale" value="M" <?= ($employee['gender'] == 'M') ? 'checked' : ''; ?>>
                            <label class="form-check-label" for="genderMale">Male</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="emp_gender" id="genderFemale" value="F" <?= ($employee['gender'] == 'F') ? 'checked' : ''; ?>>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="emp_birth_date" name="emp_birth_date" value="<?= $employee['birth_date']; ?>">
                        <?= form_error('emp_birth_date', '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="emp_hire_date">Hire Date</label>
                        <input type="date" class="form-control" id="emp_hire_date" name="emp_hire_date" value="<?= $employee['hire_date']; ?>">
