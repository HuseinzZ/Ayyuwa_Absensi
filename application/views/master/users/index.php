                        ...
                        <?php foreach ($data as $dt) : ?>
                            <tr>
                                ...
                                <?php if ($dt['u_username']) : ?>
                                    <!-- Jika user sudah punya akun -->
                                    <td class="align-middle text-center">
                                        <?= $dt['u_username']; ?>
                                    </td>
                                    <td class="align-middle text-center">
                                        <a href="<?= base_url('master/e_users/') . $dt['u_username']; ?>"
                                            class="btn btn-warning btn-icon-split btn-sm" title="Edit">
                                            <span class="icon text-white">
                                                <i class="fas fa-edit"></i>
                                            </span>
                                        </a>
                                        <a href="<?= base_url('master/d_users/') . $dt['u_username']; ?>"
                                ...
                                <?php else : ?>
                                    ...
                                    <td class="align-middle text-center">
                                        <a href="<?= base_url('master/a_users/') . $dt['e_id'] . '/' . $dt['d_id']; ?>"
