    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="<?= base_url('master/a_users/' . $employee_id . '/' . $position_id); ?>" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text"
                                    ...
                                    id="u_username"
                                    name="u_username"
                                    value="<?= strtolower($position_id) . $employee_id; ?>"
                                    readonly>
                        ...
                        <div class="form-group row">
                            <label for="u_password" class="col-sm-4 col-form-label">Password</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="u_password2" class="col-sm-4 col-form-label">Repeat Password</label>
                            <div class="col-sm-8">
