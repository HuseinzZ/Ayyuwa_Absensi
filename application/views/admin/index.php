       ...
       <div class="container-fluid">
           ...
           <div class="d-sm-flex align-items-center justify-content-between mb-4">
               <h1 class="h3 mb-0 text-black-800"><?= $title; ?></h1>
           </div>
                   ...
                   <div class="card border-left-primary shadow h-100 py-2">
                       <div class="card-body">
                           <div class="row no-gutters align-items-center">
                               <div class="col mr-2">
                                   <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Potitons</div>
                                   <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $display['c_potition']; ?> Potitions</div>
                               </div>
                               <div class="col-auto">
