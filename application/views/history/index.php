                            ...
                            <tbody>
                                <?php if ($history) : ?>
                                    <?php foreach ($history as $row) : ?>
                                        <tr>
                                            <td class="text-center"><?= date('d-m-Y', strtotime($row['attendance_date'])); ?></td>
                                            <td class="text-center"><?= $row['check_in'] ?: '-'; ?></td>
                                            <td class="text-center text-white">
                                                <?php if ($row['status_in']) : ?>
                                                    <span class="badge bg-<?= ($row['status_in'] === 'Late') ? 'danger' : 'success'; ?>">
                                                        <?= $row['status_in']; ?>
                                                    </span>
                                                <?php else : ?> - <?php endif; ?>
                                            </td>
                                            ...
                                            <td class="text-center text-white">
                                                <?php if ($row['status_out']) : ?>
                                                    <span class="badge bg-<?= ($row['status_out'] === 'Left Early') ? 'warning' : 'info'; ?>">
                                                        <?= $row['status_out']; ?>
                                                    </span>
                                                <?php else : ?> - <?php endif; ?>
                                            </td>
